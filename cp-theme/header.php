...
<header class="cp-site-header">
	<div class="cp-shell cp-header-inner">
		...
		<nav class="cp-nav" aria-label="<?php esc_attr_e( 'Primary navigation', 'cp-theme' ); ?>"><?php wp_nav_menu( array( 'theme_location' => 'primary', 'container' => false, 'fallback_cb' => false ) ); ?><details class="cp-module-menu"><summary><?php esc_html_e( 'Explore', 'cp-theme' ); ?></summary><span class="cp-module-nav"><?php cp_theme_module_navigation(); ?></span></details></nav>
