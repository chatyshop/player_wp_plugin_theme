<?php
/**
 * Template: News — Single Video
 * Video player integrated into a news article format.
 */
get_header();
?>
			...
			<div class="cp-news-article-main">
				...
				<header class="cp-news-article-header">
					...
					<div class="cp-news-article-byline">
						<span class="cp-news-author"><?php echo esc_html( $author ); ?></span>
				...
				<!-- The Video Player -->
				<div class="cp-news-player-box">
					<?php the_content(); ?>
				</div>

				<div class="cp-news-article-body">
					<p class="cp-news-video-desc"><strong><?php esc_html_e( 'Video Description:', 'cp-theme' ); ?></strong> <?php cp_theme_video_details( $post_id ); ?></p>
				</div>
				...
				<div class="cp-news-related-list">
					...
					<article class="cp-news-related-item">
						<a href="<?php echo esc_url( get_permalink( $rel->ID ) ); ?>" class="cp-news-related-thumb">
							...
							<?php if ( 'cp_video' === $rel->post_type ) : ?><div class="cp-news-video-icon-xs">▶</div><?php endif; ?>
						</a>
