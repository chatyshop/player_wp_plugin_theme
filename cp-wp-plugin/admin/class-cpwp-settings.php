...
final class CPWP_Settings {
	...
	public static function sanitize( $input ) {
		...
		$clean = array();
		foreach ( array( 'platform_name', 'tagline', 'footer_text', 'player_version', 'storage_bucket', 'storage_region', 'storage_access_key', 'home_section_order', 'home_trending_title', 'home_latest_title', 'home_most_viewed_title', 'home_category_ids', 'home_hero_title', 'home_hero_button', 'home_promo_title', 'home_promo_button' ) as $key ) {
		...
		foreach ( array( 'default_muted', 'show_sharing', 'show_transcript', 'show_related', 'enable_comments', 'enable_analytics', 'enable_login', 'enable_registration', 'comments_login_only', 'enable_password_recovery', 'enable_email_verification', 'enable_password_confirmation', 'enable_login_rate_limit', 'enable_auth_captcha', 'enable_account_deletion', 'enable_reactions', 'enable_favorites_watch_later', 'enable_playlists', 'enable_continue_watching', 'home_show_categories', 'home_show_trending', 'home_show_latest', 'home_show_most_viewed', 'home_show_category_rows', 'home_show_promo' ) as $key ) {
	...
	public static function render() {
		...
		<div class="wrap cpwp-settings"><h1><?php esc_html_e( 'CP Platform Settings', 'cp-wp-plugin' ); ?></h1><form method="post" action="options.php">
			...
			<nav class="cpwp-tabs" role="tablist">
				<?php foreach ( array( 'branding' => 'Branding', 'player' => 'Player', 'features' => 'Video Features', 'users' => 'Users', 'storage' => 'Storage', 'homepage' => 'Homepage', 'social' => 'Social', 'tools' => 'Tools' ) as $id => $label ) : ?>
	...
	private static function section( $title, $fields, $options ) {
		...
		foreach ( $fields as $key => $label ) {
			...
			if ( in_array( $key, array( 'default_muted', 'show_sharing', 'show_transcript', 'show_related', 'enable_comments', 'enable_analytics', 'enable_login', 'enable_registration', 'comments_login_only', 'enable_password_recovery', 'enable_email_verification', 'enable_password_confirmation', 'enable_login_rate_limit', 'enable_auth_captcha', 'enable_account_deletion', 'enable_reactions', 'enable_favorites_watch_later', 'enable_playlists', 'enable_continue_watching', 'home_show_categories', 'home_show_trending', 'home_show_latest', 'home_show_most_viewed', 'home_show_category_rows', 'home_show_promo' ), true ) ) {
				...
				echo '</select>';
			} elseif ( in_array( $key, array( 'home_hero_description', 'home_promo_content' ), true ) ) {
